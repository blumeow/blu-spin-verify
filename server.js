// last built: 2025-04-11 23:23:09
...
const rpc = "https://rpc.helius.xyz/?api-key=4e72b7f4-1d2b-4f7e-9ce0-160fbf1dcbb4";
...
app.post("/verify", async (req, res) => {
  ...
  try {
    ...
    console.error("Helius verification error:", err);
    return res.json({ ok: false });
  }
});

app.listen(PORT, () => console.log("Helius RPC verifier running on", PORT));